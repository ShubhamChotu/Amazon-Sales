...
-- Which Category and Size created the Highest Revenue
SELECT 
Category, 
Size,
SUM(Amount_INR) AS TotalRevenue
...
-- Least Revenue Generated Category 
SELECT 
Category,
SUM(Amount_INR) AS TotalRevenue
FROM amazon.amazon_sales
